...
# temp="$3"
seeds="1469983670"
Coefficients="0 -1 -2 -3 -4 -5 -6 -10 -15"
...
for seed in $seeds; do
  for Coefficient in $Coefficients; do
    ...
    python design_baselines/diff/generation_mean_x0.py --config $CONFIG --seed $seed --use_gpu --mode 'eval' --task $TASK --coefficient $Coefficient --which_gpu 2 --suffix "max_ds_conditioning"
  done
done
