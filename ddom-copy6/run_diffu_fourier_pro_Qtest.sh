...
seeds="314159 271828 1469983670 1369983670 1569983670 1669983670"
...
for seed in $seeds; do
  for Coefficient in $Coefficients; do
    ...
    python design_baselines/diff/trainer_amend_fourier_pro_Qtest.py --config $CONFIG --seed $seed --use_gpu --mode 'eval' --task $TASK --coefficient $Coefficient --which_gpu 4 --suffix "max_ds_conditioning"
