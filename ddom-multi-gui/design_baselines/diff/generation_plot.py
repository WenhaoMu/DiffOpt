...
def run_evaluate(
    ...
    os.makedirs("./diffusion_process_plot/normal_amend", exist_ok=True)

    # 显示图表
    # plt.savefig(f"diffusion_plot/{args.task}_{args.seed}_{args.coefficient}_noreweight.png")
    plt.savefig(f"diffusion_process_plot/normal_amend/{args.task}_{args.seed}_{args.coefficient}.png")
