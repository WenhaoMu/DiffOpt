...
def run_evaluate(
    ...
    def _get_classifier():
        # checkpoint_path = f"experiments/{taskname}/new_classifier/678/wandb/latest-run/files/checkpoints/last.ckpt"
    ...
    # 显示图表
    # plt.savefig(f"diffusion_plot/mean_{args.task}_{args.seed}_noweight.png")
    ...
    filename = f"./solution/{args.task}_fourier_mean_amend_5_projection.csv"
