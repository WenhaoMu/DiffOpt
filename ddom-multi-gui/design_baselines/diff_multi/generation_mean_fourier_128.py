...
def run_evaluate(
    ...
    def _get_classifier():
        ...
        checkpoint_path = f"experiments/{taskname}/new_classifier_fourier/123_128/wandb/latest-run/files/checkpoints/last.ckpt"
    ...
    filename = f"./solution/{args.task}_fourier_mean_amend_5__noweight_linear_128.csv"
